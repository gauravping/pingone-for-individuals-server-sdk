...
public class VerifyShareHandler implements TemplateViewRoute {
  ...
  public VerifyShareHandler(SessionHandler sessionManager, UUID applicationInstanceId,
  ...
  public ModelAndView handle(Request req, Response res) {
    ...
    requestData.put("message", "Share your \"Employment Credential\" with the site");
    requestData.put("ss_id", sessionPair.getServerSessionId());
    requestData.put("action", "request_share");
    requestData.put("requested_keys", ImmutableList.of("Employment Credential->"));
    ...
    return new ModelAndView(attributes, "verify_credential.ftl");
  }
